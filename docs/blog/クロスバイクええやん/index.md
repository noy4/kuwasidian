...
**佐渡**よかったよ、と2回ほど聞いたことがあった。ほないつか行こうかと思ってたので来た。2週間とか4週間とか居ながら、チャリで外周をゆっくり周ってみようと思った。宿でパソコン、昼夜外食、移動日散策、みたいなイメージ。

レンタサイクルの値段を調べたら5,000円/24hとか。x14日で7万円。高けえよ。島内にブックオフがあったのでそこまでバスで移動、中古でチャリが売ってないか探した。**クロスバイク**が1台あったのでそれを購入。**27,500円**。相棒、よろしくだぜ。島を出る時にまたここで売ることにする。
