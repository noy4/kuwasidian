# 月次レポートの作成
ある月に何をしていたかのレポートを作成する。

```md 28-04/index.md
# 桑記 28巻4章「」
2026年4月

<img src='./attachments/image.webp' width="400" />
...
### {😀 各トピックに対応する絵文字、タイトル}
{詳細}
{サムネタイル：トピックごとに関連動画があれば表示する。目標：各20件}
```
...
- `exclude`: レポートにまとめる際に言及しないサイト・ジャンル（履歴の取得は行う）
